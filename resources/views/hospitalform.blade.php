  ...
  <header>
    <ul class="nav nav-tabs  ms-auto w-25 mt-3" id="myTab" role="tablist">
      <li class="nav-item" role="presentation">
        <a href="/h_login" class="nav-link text-light" id="home-tab" type="button" role="tab" aria-controls="home" aria-selected="true">Login</a>
      </li>
      <li class="nav-item" role="presentation">
        <a href="/hospital" class="nav-link active" id="profile-tab"  type="button" role="tab" aria-controls="profile" aria-selected="false">Sign Up</a>
      </li>
      ...
      <div class="container">
          ...
          <div class="row">
            ...
            <div class="my-3 col-3 h-100">
              ...
              <textarea class="form-control h-100" name="adress" id="" rows="4">{{old('adress')}}</textarea>
            ...
            <div class="my-3 col-3">
              ...
              <input type="text" class="form-control" name="country" id="country" value="{{old('country')}}" placeholder="abc@mail.com">
              {{-- <small id="emailHelpId" class="form-text text-muted">Help text</small> --}}
            </div>
            <div class="my-3 col-3">
              <label for="" class="form-label">Enter City</label>
              <input type="text" class="form-control" name="city" id="city" value="{{old('city')}}" placeholder="abc@mail.com">
              {{-- <small id="emailHelpId" class="form-text text-muted">Help text</small> --}}
            </div>
            <div class="my-3 col-3">
              <label for="" class="form-label">Enter province</label>
              <input type="text" class="form-control" name="province" id="province" value="{{old('province')}}" placeholder="abc@mail.com">
              @error('province')
              <small  class="form-text text-danger">{{ $message }}</small>
            @enderror
            </div>
