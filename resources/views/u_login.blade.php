    ...
    <header>
      <ul class="nav nav-tabs  ms-auto w-25 mt-3" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <a href="/u_login" class="nav-link active" id="home-tab" type="button" role="tab" aria-controls="home" aria-selected="true">Login</a>
        </li>
        <li class="nav-item" role="presentation">
          <a href="/user" class="nav-link text-light" id="profile-tab"  type="button" role="tab" aria-controls="profile" aria-selected="false">Sign Up</a>
        </li>
