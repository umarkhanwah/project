...
<body class="bg-dark text-light">
        ...
        <header>
            <ul class="nav nav-tabs  ms-auto w-25 mt-3" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a href="/u_login" class="nav-link text-light" id="home-tab" type="button" role="tab"
                        aria-controls="home" aria-selected="true">Login</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="/user" class="nav-link active" id="profile-tab" type="button" role="tab"
    ...
    <main>
        <form action="{{ route('u_update') }}" method="POST">
            @csrf
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="my-3 col-3">
                        ...
                        <input type="text" class="form-control" name="name" id="name"
                            value="{{ $user->name }}" placeholder="abc@mail.com">
                        @error('name')
                    ...
                    <div class="my-3 col-3">
                        ...
                        <input type="number" class="form-control" name="age" id="age"
                            value="{{ $user->age }}" placeholder="abc@mail.com">
                        @error('age')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="my-3 col-3">
                        ...
                        <input type="text" class="form-control" name="phone" id="phone"
                            value="{{ $user->phone }}" placeholder="abc@mail.com">
                        @if ($errors->has('phone'))
                    ...
                    <div class="my-3 col-3 h-100">
                        ...
                        <textarea class="form-control h-100" name="adress" id="" rows="4">{{ $user->adress }}</textarea>
                    ...
                    <div class="my-3 col-3">
                        ...
                        <input type="text" class="form-control" name="password" id="password"
                            value="{{ old('password') }}" placeholder="abc@mail.com">
                        @error('password')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="my-3 col-3">
                        ...
                        <input type="text" class="form-control" name="password_confirmation"
                            id="password_confirmation" value="{{ old('password') }}" placeholder="abc@mail.com">
                        @error('password')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
